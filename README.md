...
| 伙伴远程访问                       | 待目标网络试点验收                                      |
| 自动备份与恢复                     | 尚未交付；恢复演练待完成                                |

本版本用于本地预发布运行。真实企业题集验收、完整资料格式覆盖、伙伴远程网络试点、公司模型网关计量和备份恢复演练仍在后续范围。开发计划见 [路线图](docs/boyankb/roadmap.md)，验证范围见 [验收清单](docs/boyankb/acceptance.md)，变更见 [更新日志](CHANGELOG.md)。
